...
$(document).ready(function () {
  ...
  $("#cantcuero").keyup(function (e) {
    e.preventDefault();
    var preciototal =
      $("#consumotroquel").html() * $("#preciocuero").html() * $(this).val();
  ...
  $("#crearsublimacion").click(function (e) {
    ...
    if (
      metrosublimacion.trim() !== "" &&
      proveedorsublimacion.trim() !== "" &&
      valorsublimacion.trim() !== ""
    ) {
      $.ajax({
        type: "POST",
        url: "ajax.php",
...
const cerrarModalSublimacion = document.querySelector(
  ".modal__btn--sublimacion"
);
...
const cerrarModalCorteManual = document.querySelector(
  ".modal__btn--cortemanual"
);
...
const cerrarModalTerminacion = document.querySelector(
  ".modal__btn--terminacion"
);
...
const cerrarModalEntretelado = document.querySelector(
  ".modal__btn--entretelado"
);
...
function selectCorteDigital(id) {
  const selectModalCorteDigital = document.querySelector(
    ".modal--cortedigital"
  );
  ...
  $.ajax({
    ...
    data: {
      action: action,
      corteDigitalSeleccionado: corteDigitalSeleccionado,
    },
    success: function (response) {
      if (response == 0) {
        $("#preciocortedigital").html("0");
...
const cerrarModalCorteDigital = document.querySelector(
  ".modal__btn--cortedigital"
);
  ...
  $.ajax({
    ...
    success: function (response) {
      if (response != "error") {
        ...
        $("#detacortedigital").html(info.detalle);
        $("#cortedigitaltotal").html(info.totales);
        const tbDetaCorteDigital = document.querySelector(
          ".tbdetacortedigital"
        );
