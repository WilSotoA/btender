...
$id = $_GET['id'];
$query = mysqli_query($conex, "SELECT * FROM cueros WHERE Id_cuero = $id");
...
<head>
    ...
    <title>Actualizar Cuero</title>
</head>
<body>
    <a href="../costos.php" class="btnlink">Volver</a>
    <h1 class="title">Actualizar Cuero</h1>
    <form action="" method="post">
        <table class="tb">
            ...
            <tr>
                ...
                <td><input type="text" name="descrip" id="descrip" value="<?php echo $datos['Descripcion_cuero'] ?>" required></td>
    ...
    if(isset($_POST['actualizar'])){
        ...
        $queryupd = mysqli_query($conex, "UPDATE cueros SET Descripcion_cuero='$descrip',Proveedor='$proveedor',Valor_uni='$precio' WHERE Id_cuero = $id");
        if ($queryupd){
