...
$id = $_GET['id'];
$query = mysqli_query($conex, "SELECT * FROM confeccion WHERE Id_confeccion = $id");
...
<head>
    ...
    <title>Actualizar Confección</title>
</head>
<body>
    <a href="../costos.php" class="btnlink">Volver</a>
    <h1 class="title">Actualizar Confección</h1>
    <form action="" method="post">
        <table class="tb">
            ...
            <tr>
                <td><input type="text" name="descrip" id="descrip" value="<?php echo $datos['Descripcion_confeccion'] ?>" required></td>
                <td><input type="number" name="precio" id="precio" value="<?php echo $datos['Valor_confeccion'] ?>" required></td>
            </tr>
            <tr>
    ...
    if(isset($_POST['actualizar'])){
        ...
        $queryupd = mysqli_query($conex, "UPDATE confeccion SET Descripcion_confeccion='$descrip',Valor_confeccion='$precio' WHERE Id_confeccion = $id");
        if ($queryupd){
