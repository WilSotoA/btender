...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2022 a las 22:32:08
...
--
CREATE DATABASE IF NOT EXISTS `btender` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `btender`;
...
(49, '400 CONEJOS', '400 CONEJOS', 'D', 3600),
(50, 'MILI ', 'MILI   ', 'D', 2000),
...
INSERT INTO `costos` (`Id_costos`, `Descripcion_costos`, `Fecha`, `Cliente`, `Cotizacion`, `CIF`, `Total_bruto`, `Subtotal`, `Total_impuesto`, `Total`) VALUES
(1, 'wilmer soto', '2002-12-10', 'wilmer Soto', 8000, 10000, '155439.28', '44072.51', '189597.06', '155439.28'),
(2, 'wilmer', '2002-10-17', 'wilmer', 520, 1000, '10860.55', '2817.30', '12924.05', '12924.05'),
(3, 'wilmer', '2022-10-17', 'Andrey', 520, 1500, '113077.20', '44630.88', '113642.59', '113077.20');
...
--
-- Volcado de datos para la tabla `detallesbordado`
--

INSERT INTO `detallesbordado` (`Id_detabordado`, `ID_COSTOS`, `BORDADO`, `Descripcion`, `Precio`, `Cantidad`, `Costo`) VALUES
(2, 3, 'ARDUVI', 'ARDUVI', 1700, '1.20', '2040.00');
...
--
-- Volcado de datos para la tabla `detallesconfeccion`
--

INSERT INTO `detallesconfeccion` (`Id_detaconfeccion`, `ID_COSTOS`, `CONFECCION`, `Precio`, `Cantidad`, `Costo`) VALUES
(2, 1, 'Delantal basico', 2500, '2.00', '5000.00');
...
--
-- Volcado de datos para la tabla `detallescuero`
--

INSERT INTO `detallescuero` (`Id_detacuero`, `ID_COSTOS`, `CUERO`, `Precio`, `TROQUEL`, `DCM`, `Cantidad`, `Costo`) VALUES
(9, 1, 'BADANA NEGRA', 337, 'TROQUEL 1', '0.74', '0.00', '598.51'),
(10, 2, 'CUERO VAQUETA TALA', 549, 'TROQUEL 54', '1.98', '2.50', '2717.55'),
(11, 2, 'BADANA NEGRA', 337, 'TROQUEL 1', '0.74', '0.40', '99.75'),
(12, 3, 'BADANA NEGRA', 337, 'TROQUEL 7', '0.24', '1.50', '121.32'),
(13, 3, 'CICLON CAFE', 699, 'TROQUEL 1', '0.74', '0.60', '310.36');
...
INSERT INTO `detallesinsumos` (`Id_detainsumos`, `ID_COSTOS`, `INSUMO`, `Proveedor`, `Precio`, `Cantidad`, `Costo`) VALUES
(9, 3, 'BROCHE CAZUELA 19 LINEAS INOXIDABLE PL', 'SUS HERRAJES', 465, '2.00', '930.00'),
(10, 3, 'CINTA FAYA UNICOLOR', 'MIL HERRAJES', 200, '0.50', '100.00'),
(11, 3, 'ARGOLLA 04-006-4 PL', 'SUS HERRAJES', 1950, '1.50', '2925.00');
...
--
-- Volcado de datos para la tabla `detallestela`
--

INSERT INTO `detallestela` (`Id_detatela`, `ID_COSTOS`, `TELA`, `Precio`, `Cantidad`, `Costo`) VALUES
(11, 1, 'ALESSIO', 18037, '2.00', '36074.00'),
(12, 1, 'wilmer', 1000, '2.40', '2400.00'),
(13, 3, 'ALESSIO', 18037, '1.00', '18037.00'),
(14, 3, 'GAB TEMPO', 16806, '1.20', '20167.20');
...
(4, 'Delantal grande', 6000),
(5, 'Delantal medio', 2600),
(6, '1 bolsillo', 1300),
(7, '2 bolsillos', 2600),
(8, '1 bolsillo de 36x21', 2600),
(9, 'pieza cuello', 1000);
...
--
-- Volcado de datos para la tabla `impuestoscostos`
--

INSERT INTO `impuestoscostos` (`Id_detaimpuestos`, `ID_COSTOS`, `Impuestos`, `Valor_impuesto`) VALUES
(1, 1, 'IVA', '0.190'),
(2, 1, 'ICA', '0.000'),
(3, 1, 'RETE', '0.025'),
(4, 1, 'UTILIDAD', '2.300'),
...
(5, 'MOSQUETON 2137-20 NIQUEL', 'SUS HERRAJES', 2800),
(6, 'HEBILLA 2 PLATA', 'MIL HERRAJES', 999),
(7, 'CORDON SUDADERA', 'MIL HERRAJES', 89),
(8, 'TANKA', 'MIL HERRAJES', 180),
...
(4, 'planchado y empaque', 400),
(5, 'remachar', 50),
(6, 'perforar', 50),
(7, 'poner ojaletes', 100),
(8, 'marcar', 10),
(9, 'pintar', 500),
(10, 'andrey', 234);
...
INSERT INTO `troquel` (`Id_troquel`, `Nombre_troquel`, `DCM`, `Img_troquel`) VALUES
(178, 'molde', '4.92', );
...
--
ALTER TABLE `bordado`
  MODIFY `Id_bordado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT de la tabla `confeccion`
--
ALTER TABLE `confeccion`
  MODIFY `Id_confeccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `cortedigital`
--
ALTER TABLE `cortedigital`
  MODIFY `Id_cortedigital` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `detallesbordado`
  MODIFY `Id_detabordado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `detallesconfeccion`
--
ALTER TABLE `detallesconfeccion`
  MODIFY `Id_detaconfeccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `detallescortemanual`
  MODIFY `Id_detacortemanual` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `detallescuero`
--
ALTER TABLE `detallescuero`
  MODIFY `Id_detacuero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `detallesentretelado`
--
ALTER TABLE `detallesentretelado`
  MODIFY `Id_detaentretelado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `detallesinsumos`
--
ALTER TABLE `detallesinsumos`
  MODIFY `Id_detainsumos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `detalleslaser`
--
ALTER TABLE `detalleslaser`
  MODIFY `Id_detalaser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `detallessublimacion`
--
ALTER TABLE `detallessublimacion`
  MODIFY `Id_detatela` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `detallestela`
--
ALTER TABLE `detallestela`
  MODIFY `Id_detatela` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `detatempbordado`
  MODIFY `Id_tempbordado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `detatempconfeccion`
--
ALTER TABLE `detatempconfeccion`
  MODIFY `Id_tempconfeccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `detatempcortemanual`
  MODIFY `Id_tempcortemanual` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `detatempcuero`
--
ALTER TABLE `detatempcuero`
  MODIFY `Id_tempcuero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `detatempentretelado`
--
ALTER TABLE `detatempentretelado`
  MODIFY `Id_tempentretelado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `detatempinsumos`
--
ALTER TABLE `detatempinsumos`
  MODIFY `Id_tempinsumo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `detatemplaser`
--
ALTER TABLE `detatemplaser`
  MODIFY `Id_templaser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `detatempsublimacion`
--
ALTER TABLE `detatempsublimacion`
  MODIFY `Id_tempsublimacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `detatemptelas`
--
ALTER TABLE `detatemptelas`
  MODIFY `Id_temptela` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `entretelado`
  MODIFY `Id_entretelado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `impuestoscostos`
  MODIFY `Id_detaimpuestos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `laser`
  MODIFY `Id_laser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
...
--
ALTER TABLE `sublimacion`
  MODIFY `Id_sublimacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `telas`
--
ALTER TABLE `telas`
  MODIFY `Id_tela` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `terminacion`
--
ALTER TABLE `terminacion`
  MODIFY `Id_terminacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `troquel`
--
ALTER TABLE `troquel`
  MODIFY `Id_troquel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179;
...
--
CREATE DATABASE IF NOT EXISTS `panaderia` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `panaderia`;
...
CREATE TABLE `clientes` (
  ...
  `Telefono_cliente` double NOT NULL,
...
INSERT INTO `clientes` (`Id_cliente`, `Nombre_cliente`, `Apellido_cliente`, `Direccion_cliente`, `Telefono_cliente`, `Correo_cliente`) VALUES
(1, 'Juan', 'Soto Almeida', 'av 14', 3219822134, 'juansoto@gmail.com'),
(2, 'Juan Camilo', 'Soto Almeida', 'av 14', 3219822134, 'juansoto@gmail.com'),
(3, 'dreyner', 'Soto', 'av 120 avenue', 321923222, 'dreyner@gmail.com');
...
CREATE TABLE `empleados` (
  ...
  `Foto_empleado` blob DEFAULT NULL,
...
INSERT INTO `empleados` (`Id_empleado`, `Nombre_empleado`, `Apellido_empleado`, `Direccion_empleado`, `Telefono_empleado`, `Correo_empleado`, `Foto_empleado`, `Contrasena`, `ID_ROL`) VALUES
(1, 'Admin', NULL, NULL, NULL, NULL, , '$2y$10$bZI2Q.lpAzJPUOnsTDFb5.P5QR3PduujnqsMVKsFnRUkNnxPUpv3K$2y$10$bZI2Q.lpAzJPUOnsTDFb5.P5QR3PduujnqsMVKsFnRUkNnxPUpv3K', 1),
(1092525186, 'Alirio ', 'Avendaño', 'Av 10 #4-56 Loma', 3129875638, 'alirioa@gmail.com', , '$2y$10$OxVKNyaBPqmvMp/MaPfUMehO6F7xKyJLXPQZgYJwxsB.JrZ4UHAUW$2y$10$OxVKNyaBPqmvMp/MaPfUMehO6F7xKyJLXPQZgYJwxsB.JrZ4UHAUW', 2);
...
INSERT INTO `facturas` (`Id_factura`, `Descripcion_factura`, `Fecha_factura`, `Total_factura`, `ID_PERSONAL`, `ID_CLIENTE`) VALUES
(1, 'Listo', '2022-09-28 00:00:00', 3000, 0, 0),
(2, 'sdasd', '2022-09-28 00:00:00', 24000, 1, 1),
(3, 'sdasd', '2022-09-26 00:00:00', 3000, 1, 1),
(4, 'bien', '2022-09-26 00:00:00', 9000, 1, 1),
(5, 'wilmer', '2022-09-26 00:00:00', 3000, 1, 1),
(6, 'sdasdsd', '2022-09-26 00:00:00', 3000, 1, 1),
(7, 'sdasdad', '2022-09-26 00:00:00', 3000, 1, 1),
(8, 'dasdasd', '2022-09-28 00:00:00', 9000, 1, 1),
(9, 'dasds', '2022-09-01 00:00:00', 24000, 1, 2),
(10, 'sasdsd', '2022-09-29 00:00:00', 15000, 1, 1),
(11, 'dgdfg', '2022-10-06 00:00:00', 9000, 1, 1);
...
INSERT INTO `insumos` (`Id_producto`, `Nombre_producto`, `Stock`, `Valor_producto`, `ID_PROVEEDOR`) VALUES
(1, 'Leche', 20, 3000, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `insumosfactura`
--

CREATE TABLE `insumosfactura` (
  `Id` int(11) NOT NULL,
  `ID_PRODUCTO` int(11) NOT NULL,
  `ID_FACTURA` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `insumosfactura`
--

INSERT INTO `insumosfactura` (`Id`, `ID_PRODUCTO`, `ID_FACTURA`, `Cantidad`, `Precio`) VALUES
(1, 1, 4, 1, 3000),
(2, 1, 4, 2, 3000),
(27, 1, 2, 4, 3000),
(28, 1, 2, 1, 3000),
...
--
-- Estructura de tabla para la tabla `insumotemp`
--

CREATE TABLE `insumotemp` (
...
CREATE TABLE `proovedores` (
  ...
  `Telefono_proveedor` double NOT NULL,
...
INSERT INTO `proovedores` (`Id_proveedor`, `Nombre_proveedor`, `Apellido_proveedor`, `Telefono_proveedor`, `Correo_proveedor`) VALUES
(1, 'Juan', 'Soto', 3218734921, 'juansoto@gmail.com');
...
ALTER TABLE `empleados`
  ...
  ADD KEY `Correo_personal` (`Correo_empleado`),
...
--
-- Indices de la tabla `insumosfactura`
--
ALTER TABLE `insumosfactura`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `ID_PRODUCTO` (`ID_PRODUCTO`),
  ADD KEY `ID_FACTURA` (`ID_FACTURA`);

--
-- Indices de la tabla `insumotemp`
--
ALTER TABLE `insumotemp`
...
--
-- AUTO_INCREMENT de la tabla `insumosfactura`
--
ALTER TABLE `insumosfactura`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `insumotemp`
--
ALTER TABLE `insumotemp`
  MODIFY `Id_temp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `insumos`
  ADD CONSTRAINT `insumos_ibfk_1` FOREIGN KEY (`ID_PROVEEDOR`) REFERENCES `proovedores` (`Id_proveedor`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `insumosfactura`
--
ALTER TABLE `insumosfactura`
  ADD CONSTRAINT `insumosfactura_ibfk_1` FOREIGN KEY (`ID_PRODUCTO`) REFERENCES `insumos` (`Id_producto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `insumosfactura_ibfk_2` FOREIGN KEY (`ID_FACTURA`) REFERENCES `facturas` (`Id_factura`);

--
-- Filtros para la tabla `insumotemp`
--
ALTER TABLE `insumotemp`
  ADD CONSTRAINT `insumotemp_ibfk_1` FOREIGN KEY (`ID_PRODUCTO`) REFERENCES `insumos` (`Id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
('root', '[{\"db\":\"btender\",\"table\":\"laser\"},{\"db\":\"btender\",\"table\":\"detatempcortedigital\"},{\"db\":\"btender\",\"table\":\"cortedigital\"},{\"db\":\"btender\",\"table\":\"detallescortedigital\"},{\"db\":\"btender\",\"table\":\"detallesentretelado\"},{\"db\":\"btender\",\"table\":\"detatempentretelado\"},{\"db\":\"btender\",\"table\":\"entretelado\"},{\"db\":\"btender\",\"table\":\"detallesterminacion\"},{\"db\":\"btender\",\"table\":\"detatempterminacion\"},{\"db\":\"btender\",\"table\":\"detatempconfeccion\"}]');
...
('root', '2022-10-13 22:06:05', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":0}');
